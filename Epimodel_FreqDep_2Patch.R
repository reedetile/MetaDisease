...
beta_plot <- ggplot(data = connect_sens, aes(x = BetaDiversity, y = LandscapeR0))+
  geom_point()+
...
abun_R0_plot <- ggplot(data = connect_sens, aes(x = TotalAbundance, y = LandscapeR0))+
  geom_point()+
  geom_smooth(method = 'lm')+
  theme_classic()+
  xlab("Abundance")+
...
beta_relative_plot <- ggplot(data = connect_sens, aes(x = Beta_relative, y = LandscapeR0))+
  geom_point()+
  geom_smooth(method = 'lm')+
  theme_classic()+
...
gamma_plot <- ggplot(data = connect_sens, aes(x = Gamma_diversity, y = LandscapeR0))+
...
# okay now lets examine diversity correct for connectivity
beta_conn <- connect_sens %>% 
  mutate(beta_conn = BetaDiversity/Connectivity) %>%
  ggplot(aes(x = beta_conn, y = LandscapeR0)) +
  geom_point()+
  geom_smooth(method = 'lm')+
  theme_classic()+
  xlab("Beta Diversity / Connectivity")+
  ylab("Landscape R0")
beta_conn

gamma_conn <- connect_sens %>% 
  mutate(gamma_conn = Gamma_diversity/Connectivity) %>%
  ggplot(aes(x = gamma_conn, y = LandscapeR0)) +
  geom_point()+
  geom_smooth(method = 'lm')+
  theme_classic()+
  xlab("Gamma Diversity / Connectivity")+
  ylab("Landscape R0")
gamma_conn
